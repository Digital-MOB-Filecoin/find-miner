...
var (
	...
	RootCmd = &cobra.Command{
		Use:   "find-miner",
		Short: "The use case for find-miner is to enable a user of the Lotus CLI or API to select a miner for a given type of storage deal.",
...
func init() {
	...
	RootCmd.Flags().Int64("size", 0, "Deal size in bytes")
	...
	RootCmd.Flags().String("verified", "", "Verified deal (true/false)")
	RootCmd.Flags().String("fastRetrieval", "", "Fast Retrieval")
